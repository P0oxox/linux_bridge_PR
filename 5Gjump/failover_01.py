...
# from try_MultipleWAN import info
...
jsonFile = open('/home/pp/linux_bridge_PR/5Gjump/info_temp.json','r')
...
path_to_file = "/home/pp/linux_bridge_PR/5Gjump/info.json"
# path_to_file1 = "/home/pp/linux_bridge_PR/5Gjump/test.json"
if __name__ == '__main__':

    while True:
        info_status=choose_status.choose_status()
        # print(info_status)
        with open(path_to_file, "w") as f:
            f.write(json.dumps(info_status))
        # with open(path_to_file1, "a") as f:
